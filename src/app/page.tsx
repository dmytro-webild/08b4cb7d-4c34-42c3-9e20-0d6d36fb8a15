...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/portrait-handsome-confident-stylish-hipster-lambersexual-modelsexy-modern-man-dressed-elegant-suit-spectacles-fashion-male-posing-studio-near-blue-wall-looking-camera-glasses_158538-21056.jpg",
          alt: "Portrait of handsome confident stylish hipster",
        },
        {
          src: "http://img.b2bpic.net/free-photo/young-male-white-shirt-jacket-standing-with-crossed-arms-looking-serious-front-view_176474-99669.jpg",
          alt: "Young male in white shirt, jacket standing",
        },
        {
        ...
        },
        {
          ...
          alt: "Young male holding hands in pockets",
        },
        {
      ...
      testimonials={[
        {
          ...
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-young-confident-man_176474-85949.jpg",
        },
        {
          id: "t2",
          name: "Elena Vance",
          role: "CTO",
          company: "VanceFinance",
          rating: 5,
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "How secure is my portfolio?",
          content: "We use industry-leading cold storage and multi-sig protocols.",
        },
        {
          id: "q2",
          title: "Can I trade institutional size?",
          content: "Yes, our Institutional plan is designed for large OTC trades.",
        },
        {
          id: "q3",
          title: "Is my data protected?",
          content: "We maintain rigorous data privacy and encryption standards.",
        },
      ]}
